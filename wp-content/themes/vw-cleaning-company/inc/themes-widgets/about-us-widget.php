...
class VW_Cleaning_Company_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Cleaning_Company_About_Widget',
			__('VW About us', 'vw-cleaning-company'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-cleaning-company' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-cleaning-company'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-cleaning-company'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-cleaning-company'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-cleaning-company'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-cleaning-company'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-cleaning-company'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_cleaning_company_about_custom_load_widget() {
	register_widget( 'VW_Cleaning_Company_About_Widget' );
}
add_action( 'widgets_init', 'vw_cleaning_company_about_custom_load_widget' );